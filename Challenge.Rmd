...
plot(1:ncol(eeg1), eeg1[1, ], type = 'l', ylab = "Amplitude en uV", xlab = "30 secondes d'enregistrement d'une fréquence de 50Hz", main = "EEG position 1 - enregist. 1")
```
...
Vous trouverez dans la partie 8 du rapport les trois fichiers .R du code complet utilisé pour la génération du modèle:
...
* source_final.R: code appelant les deux fichiers précédents, générant les features et le tableau final des features, crééant le modèle final et calculant enfin les classes de l'échantillon test.
