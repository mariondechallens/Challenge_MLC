...
Cette erreur est calculée est donc de la valisation croisée car les individus out-of-the-bag consitituent l'échantillon test avec en moyenne un tiers des données (voir graphique de la section 6.)
