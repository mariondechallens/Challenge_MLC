...
Après la simulation de tous les arbres, nous allons alors pouvoir calculer la "out-of-the-bag error estimate" comme suit : pour chaque individu "n", nous allons lui attribuer la classe "j" comme étant celle pour laquelle il a été classé le plus grand nombre de fois. Ainsi, la "out-of-the-bag error" est obtenue en prenant le nombre de fois où "j" n'est pas la bonne classe de l'individu "n" divisé par le nombre total d'individu.
