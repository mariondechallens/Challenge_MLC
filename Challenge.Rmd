...
La validation croisée est réalisée par l'algorithme de Random Forest lui-même (le "Out-of-the-bag error estimate").Pour chaque arbre simulé, deux tiers des données tiré aléatoirement sont utilisés pour l'apprentissage et le reste pour le test du modèle. A chaque simulation, l'algorithme simule l'arbre de classification, puis va classer les données test à partir de cet arbre. 

Après la simulation de tous les arbres, nous allons alors pouvoir calculer la "out-of-the-bag error estimate" comme suit : pour chaque individu "n", nous allons lui attribuer la classe "j" comme étant celle pour laquelle il a été classifié le plus grand nombre de fois. Ainsi, la "out-of-the-bag error" est obtenue en prenant le nombre de fois où "j" n'est pas la bonne classe de l'individu "n" divisé par le nombre total d'individu.
