...
plot(1:ncol(eeg1), eeg1[1, ], type = 'l', ylab = "Amplitude en uV", xlab = "30 secondes d'enregistrement `une fréquence de 50Hz", main = "EEG position 1 - enregist. 1",align = "center")
```
...
# imp = read.csv(paste0(data_folder,"imp2.csv")) #fichier contenant les variables d'importance
...
Remarques : Il y a 71 variables dans le modèle sur plus de 200 calculées et testées, ce qui est beaucoup.
